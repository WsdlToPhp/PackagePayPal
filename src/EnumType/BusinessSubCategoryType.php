...
/**
 * This class stands for BusinessSubCategoryType EnumType
 * Meta information extracted from the WSDL
 * - documentation: BusinessSubCategoryType
 * @subpackage Enumerations
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class BusinessSubCategoryType extends AbstractStructEnumBase
{
    /**
     * Constant for value 'SubCategory-Unspecified'
     * @return string 'SubCategory-Unspecified'
     */
    const VALUE_SUB_CATEGORY_UNSPECIFIED = 'SubCategory-Unspecified';
    /**
     ...
     */
    const VALUE_ANTIQUES_RUGS_CARPETS = 'ANTIQUES-RugsCarpets';
    /**
     ...
     */
    const VALUE_BOOKS_NON_FICTION = 'BOOKS-NonFiction';
    /**
     ...
     */
    const VALUE_BUSINESS_GENERAL_SERVICES = 'BUSINESS-GeneralServices';
    /**
     ...
     */
    const VALUE_COMPUTERHARDWAREANDSOFTWARE_GENERAL_SOFTWARE = 'COMPUTERHARDWAREANDSOFTWARE-GeneralSoftware';
    /**
     ...
     */
    const VALUE_ELECTRONICSANDTELECOM_GENERAL_TELECOM = 'ELECTRONICSANDTELECOM-GeneralTelecom';
    /**
     ...
     */
    const VALUE_ELECTRONICSANDTELECOM_GENERAL_ELECTRONICS = 'ELECTRONICSANDTELECOM-GeneralElectronics';
    /**
     ...
     */
    const VALUE_ELECTRONICSANDTELECOM_SCANNERS_RADIOS = 'ELECTRONICSANDTELECOM-ScannersRadios';
    /**
     ...
     */
    const VALUE_HOBBIESTOYSANDGAMES_BACKUP_UNRELEASED_GAMES = 'HOBBIESTOYSANDGAMES-BackupUnreleased-Games';
    /**
     ...
     */
    const VALUE_MONEYSERVICEBUSINESSES_CURRENCY_DEALER_EXCHANGE = 'MONEYSERVICEBUSINESSES-Currency-DealerExchange';
    /**
     ...
     */
    const VALUE_SERVICES_GENERAL_GOVERNMENT = 'SERVICES-GeneralGovernment';
    /**
     ...
     */
    const VALUE_SERVICES_IMPORTING_EXPORTING = 'SERVICES-ImportingExporting';
    /**
     * Constant for value 'SERVICES-InsuranceDirect'
     * @return string 'SERVICES-InsuranceDirect'
     */
    const VALUE_SERVICES_INSURANCE_DIRECT = 'SERVICES-InsuranceDirect';
    /**
     ...
     */
    const VALUE_TRAVEL_AIRLINES_SPIRIT_AIR = 'TRAVEL-AirlinesSpirit-Air';
    /**
     * Constant for value 'Other-SubCategories'
     * @return string 'Other-SubCategories'
     */
    const VALUE_OTHER_SUB_CATEGORIES = 'Other-SubCategories';
    /**
     * Return allowed values
     * @uses self::VALUE_SUB_CATEGORY_UNSPECIFIED
     * @uses self::VALUE_ANTIQUES_GENERAL
     * @uses self::VALUE_ANTIQUES_ANTIQUITIES
     * @uses self::VALUE_ANTIQUES_DECORATIVE
     * @uses self::VALUE_ANTIQUES_BOOKS_MANUSCRIPTS
     * @uses self::VALUE_ANTIQUES_FURNITURE
     * @uses self::VALUE_ANTIQUES_GLASS
     * @uses self::VALUE_ANTIQUES_RUGS_CARPETS
     * @uses self::VALUE_ANTIQUES_POTTERY
     * @uses self::VALUE_ANTIQUES_CULTURAL
     * @uses self::VALUE_ANTIQUES_ARTIFACTS_GRAVE_RELATED_AND_NATIVE_AMERICAN_CRAFTS
     * @uses self::VALUE_ARTSANDCRAFTS_GENERAL
     * @uses self::VALUE_ARTSANDCRAFTS_ART_DEALER_AND_GALLERIES
     * @uses self::VALUE_ARTSANDCRAFTS_PRINTS
     * @uses self::VALUE_ARTSANDCRAFTS_PAINTING
     * @uses self::VALUE_ARTSANDCRAFTS_PHOTOGRAPHY
     * @uses self::VALUE_ARTSANDCRAFTS_REPRODUCTIONS
     * @uses self::VALUE_ARTSANDCRAFTS_SCULPTURES
     * @uses self::VALUE_ARTSANDCRAFTS_WOODWORKING
     * @uses self::VALUE_ARTSANDCRAFTS_ART_AND_CRAFT_SUPPLIES
     * @uses self::VALUE_ARTSANDCRAFTS_FABRICS_AND_SEWING
     * @uses self::VALUE_ARTSANDCRAFTS_QUILTING
     * @uses self::VALUE_ARTSANDCRAFTS_SCRAPBOOKING
     * @uses self::VALUE_AUTOMOTIVE_GENERAL
     * @uses self::VALUE_AUTOMOTIVE_AUTOS
     * @uses self::VALUE_AUTOMOTIVE_AVIATION
     * @uses self::VALUE_AUTOMOTIVE_MOTORCYCLES
     * @uses self::VALUE_AUTOMOTIVE_PARTS_AND_SUPPLIES
     * @uses self::VALUE_AUTOMOTIVE_SERVICES
     * @uses self::VALUE_AUTOMOTIVE_VINTAGE_AND_COLLECTIBLE_VEHICLES
     * @uses self::VALUE_BEAUTY_GENERAL
     * @uses self::VALUE_BEAUTY_BODY_CARE_PERSONAL_HYGIENE
     * @uses self::VALUE_BEAUTY_FRAGRANCES_AND_PERFUMES
     * @uses self::VALUE_BEAUTY_MAKEUP
     * @uses self::VALUE_BOOKS_GENERAL
     * @uses self::VALUE_BOOKS_AUDIO_BOOKS
     * @uses self::VALUE_BOOKS_CHILDREN_BOOKS
     * @uses self::VALUE_BOOKS_COMPUTER_BOOKS
     * @uses self::VALUE_BOOKS_EDUCATIONAL_AND_TEXTBOOKS
     * @uses self::VALUE_BOOKS_MAGAZINES
     * @uses self::VALUE_BOOKS_FICTION_AND_LITERATURE
     * @uses self::VALUE_BOOKS_NON_FICTION
     * @uses self::VALUE_BOOKS_VINTAGE_AND_COLLECTIBLES
     * @uses self::VALUE_BUSINESS_GENERAL
     * @uses self::VALUE_BUSINESS_AGRICULTURAL
     * @uses self::VALUE_BUSINESS_CONSTRUCTION
     * @uses self::VALUE_BUSINESS_EDUCATIONAL
     * @uses self::VALUE_BUSINESS_INDUSTRIAL
     * @uses self::VALUE_BUSINESS_OFFICE_SUPPLIES_AND_EQUIPMENT
     * @uses self::VALUE_BUSINESS_GENERAL_SERVICES
     * @uses self::VALUE_BUSINESS_ADVERTISING
     * @uses self::VALUE_BUSINESS_EMPLOYMENT
     * @uses self::VALUE_BUSINESS_MARKETING
     * @uses self::VALUE_BUSINESS_MEETING_PLANNERS
     * @uses self::VALUE_BUSINESS_MESSAGING_AND_PAGING_SERVICES
     * @uses self::VALUE_BUSINESS_SEMINARS
     * @uses self::VALUE_BUSINESS_PUBLISHING
     * @uses self::VALUE_BUSINESS_SHIPPING_AND_PACKAGING
     * @uses self::VALUE_BUSINESS_WHOLESALE
     * @uses self::VALUE_BUSINESS_INDUSTRIAL_SOLVENTS
     * @uses self::VALUE_CAMERASANDPHOTOGRAPHY_GENERAL
     * @uses self::VALUE_CAMERASANDPHOTOGRAPHY_ACCESSORIES
     * @uses self::VALUE_CAMERASANDPHOTOGRAPHY_CAMERAS
     * @uses self::VALUE_CAMERASANDPHOTOGRAPHY_VIDEO_EQUIPMENT
     * @uses self::VALUE_CAMERASANDPHOTOGRAPHY_FILM
     * @uses self::VALUE_CAMERASANDPHOTOGRAPHY_SUPPLIES
     * @uses self::VALUE_CLOTHING_ACCESSORIES
     * @uses self::VALUE_CLOTHING_BABIES_CLOTHING_AND_SUPPLIES
     * @uses self::VALUE_CLOTHING_CHILDRENS_CLOTHING
     * @uses self::VALUE_CLOTHING_MENS_CLOTHING
     * @uses self::VALUE_CLOTHING_SHOES
     * @uses self::VALUE_CLOTHING_WEDDING_CLOTHING
     * @uses self::VALUE_CLOTHING_WOMENS_CLOTHING
     * @uses self::VALUE_CLOTHING_GENERAL
     * @uses self::VALUE_CLOTHING_JEWELRY
     * @uses self::VALUE_CLOTHING_WATCHES_AND_CLOCKS
     * @uses self::VALUE_CLOTHING_RINGS
     * @uses self::VALUE_COLLECTIBLES_GENERAL
     * @uses self::VALUE_COLLECTIBLES_ADVERTISING
     * @uses self::VALUE_COLLECTIBLES_ANIMALS
     * @uses self::VALUE_COLLECTIBLES_ANIMATION
     * @uses self::VALUE_COLLECTIBLES_COIN_OPERATED_BANKS_AND_CASINOS
     * @uses self::VALUE_COLLECTIBLES_COINS_AND_PAPER_MONEY
     * @uses self::VALUE_COLLECTIBLES_COMICS
     * @uses self::VALUE_COLLECTIBLES_DECORATIVE
     * @uses self::VALUE_COLLECTIBLES_DISNEYANA
     * @uses self::VALUE_COLLECTIBLES_HOLIDAY
     * @uses self::VALUE_COLLECTIBLES_KNIVES_AND_SWORDS
     * @uses self::VALUE_COLLECTIBLES_MILITARIA
     * @uses self::VALUE_COLLECTIBLES_POSTCARDS_AND_PAPER
     * @uses self::VALUE_COLLECTIBLES_STAMPS
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_GENERAL
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_DESKTOP_PCS
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_MONITORS
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_HARDWARE
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_PERIPHERALS
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_LAPTOPS_NOTEBOOKS_PDAS
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_NETWORKING_EQUIPMENT
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_PARTS_AND_ACCESSORIES
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_GENERAL_SOFTWARE
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_OEM_SOFTWARE
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_ACADEMIC_SOFTWARE
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_BETA_SOFTWARE
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_GAME_SOFTWARE
     * @uses self::VALUE_COMPUTERHARDWAREANDSOFTWARE_DATA_PROCESSING_SVC
     * @uses self::VALUE_CULTUREANDRELIGION_GENERAL
     * @uses self::VALUE_CULTUREANDRELIGION_CHRISTIANITY
     * @uses self::VALUE_CULTUREANDRELIGION_METAPHYSICAL
     * @uses self::VALUE_CULTUREANDRELIGION_NEW_AGE
     * @uses self::VALUE_CULTUREANDRELIGION_ORGANIZATIONS
     * @uses self::VALUE_CULTUREANDRELIGION_OTHER_FAITHS
     * @uses self::VALUE_CULTUREANDRELIGION_COLLECTIBLES
     * @uses self::VALUE_ELECTRONICSANDTELECOM_GENERAL_TELECOM
     * @uses self::VALUE_ELECTRONICSANDTELECOM_CELL_PHONES_AND_PAGERS
     * @uses self::VALUE_ELECTRONICSANDTELECOM_TELEPHONE_CARDS
     * @uses self::VALUE_ELECTRONICSANDTELECOM_TELEPHONE_EQUIPMENT
     * @uses self::VALUE_ELECTRONICSANDTELECOM_TELEPHONE_SERVICES
     * @uses self::VALUE_ELECTRONICSANDTELECOM_GENERAL_ELECTRONICS
     * @uses self::VALUE_ELECTRONICSANDTELECOM_CAR_AUDIO_AND_ELECTRONICS
     * @uses self::VALUE_ELECTRONICSANDTELECOM_HOME_ELECTRONICS
     * @uses self::VALUE_ELECTRONICSANDTELECOM_HOME_AUDIO
     * @uses self::VALUE_ELECTRONICSANDTELECOM_GADGETS_AND_OTHER_ELECTRONICS
     * @uses self::VALUE_ELECTRONICSANDTELECOM_BATTERIES
     * @uses self::VALUE_ELECTRONICSANDTELECOM_SCANNERS_RADIOS
     * @uses self::VALUE_ELECTRONICSANDTELECOM_RADAR_DECTORS
     * @uses self::VALUE_ELECTRONICSANDTELECOM_RADAR_JAMMING_DEVICES
     * @uses self::VALUE_ELECTRONICSANDTELECOM_SATELLITE_AND_CABLE_TV_DESCRAMBLERS
     * @uses self::VALUE_ELECTRONICSANDTELECOM_SURVEILLANCE_EQUIPMENT
     * @uses self::VALUE_ENTERTAINMENT_GENERAL
     * @uses self::VALUE_ENTERTAINMENT_MOVIES
     * @uses self::VALUE_ENTERTAINMENT_MUSIC
     * @uses self::VALUE_ENTERTAINMENT_CONCERTS
     * @uses self::VALUE_ENTERTAINMENT_THEATER
     * @uses self::VALUE_ENTERTAINMENT_BOOTLEG_RECORDINGS
     * @uses self::VALUE_ENTERTAINMENT_PROMOTIONAL_ITEMS
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_GENERAL
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_AUTOGRAPHS
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_LIMITED_EDITIONS
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_MOVIE
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_MUSIC
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_NOVELTIES
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_PHOTOS
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_POSTERS
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_SPORTS_AND_FAN_SHOP
     * @uses self::VALUE_ENTERTAINMENTMEMORABILIA_SCIENCE_FICTION
     * @uses self::VALUE_FOODDRINKANDNUTRITION_GENERAL
     * @uses self::VALUE_FOODDRINKANDNUTRITION_COFFEE_AND_TEA
     * @uses self::VALUE_FOODDRINKANDNUTRITION_FOOD_PRODUCTS
     * @uses self::VALUE_FOODDRINKANDNUTRITION_GOURMET_ITEMS
     * @uses self::VALUE_FOODDRINKANDNUTRITION_HEALTH_AND_NUTRITION
     * @uses self::VALUE_FOODDRINKANDNUTRITION_SERVICES
     * @uses self::VALUE_FOODDRINKANDNUTRITION_VITAMINS_AND_SUPPLEMENTS
     * @uses self::VALUE_FOODDRINKANDNUTRITION_WEIGHT_MANAGEMENT_AND_HEALTH_PRODUCTS
     * @uses self::VALUE_FOODDRINKANDNUTRITION_RESTAURANT
     * @uses self::VALUE_FOODDRINKANDNUTRITION_TOBACCO_AND_CIGARS
     * @uses self::VALUE_FOODDRINKANDNUTRITION_ALCOHOLIC_BEVERAGES
     * @uses self::VALUE_GIFTSANDFLOWERS_GENERAL
     * @uses self::VALUE_GIFTSANDFLOWERS_FLOWERS
     * @uses self::VALUE_GIFTSANDFLOWERS_GREETING_CARDS
     * @uses self::VALUE_GIFTSANDFLOWERS_HUMOROUS_GIFTS_AND_NOVELTIES
     * @uses self::VALUE_GIFTSANDFLOWERS_PERSONALIZED_GIFTS
     * @uses self::VALUE_GIFTSANDFLOWERS_PRODUCTS
     * @uses self::VALUE_GIFTSANDFLOWERS_SERVICES
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_GENERAL
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_ACTION_FIGURES
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_BEAN_BABIES
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_BARBIES
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_BEARS
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_DOLLS
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_GAMES
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_MODEL_KITS
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_DIECAST_TOYS_VEHICLES
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_VIDEO_GAMES_AND_SYSTEMS
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_VINTAGE_AND_ANTIQUE_TOYS
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_BACKUP_UNRELEASED_GAMES
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_GAME_COPYING_HARDWARESOFTWARE
     * @uses self::VALUE_HOBBIESTOYSANDGAMES_MOD_CHIPS
     * @uses self::VALUE_HOMEANDGARDEN_GENERAL
     * @uses self::VALUE_HOMEANDGARDEN_APPLIANCES
     * @uses self::VALUE_HOMEANDGARDEN_BED_AND_BATH
     * @uses self::VALUE_HOMEANDGARDEN_FURNISHING_AND_DECORATING
     * @uses self::VALUE_HOMEANDGARDEN_GARDEN_SUPPLIES
     * @uses self::VALUE_HOMEANDGARDEN_HARDWARE_AND_TOOLS
     * @uses self::VALUE_HOMEANDGARDEN_HOUSEHOLD_GOODS
     * @uses self::VALUE_HOMEANDGARDEN_KITCHENWARE
     * @uses self::VALUE_HOMEANDGARDEN_RUGS_AND_CARPETS
     * @uses self::VALUE_HOMEANDGARDEN_SECURITY_AND_HOME_DEFENSE
     * @uses self::VALUE_HOMEANDGARDEN_PLANTS_AND_SEEDS
     * @uses self::VALUE_INTERNETANDNETWORKSERVICES_GENERAL
     * @uses self::VALUE_INTERNETANDNETWORKSERVICES_BULLETIN_BOARD
     * @uses self::VALUE_INTERNETANDNETWORKSERVICES_ONLINE_SERVICES
     * @uses self::VALUE_INTERNETANDNETWORKSERVICES_AUCTION_MANAGEMENT_TOOLS
     * @uses self::VALUE_INTERNETANDNETWORKSERVICES_ECOMMERCE_DEVELOPMENT
     * @uses self::VALUE_INTERNETANDNETWORKSERVICES_TRAINING_SERVICES
     * @uses self::VALUE_INTERNETANDNETWORKSERVICES_ONLINE_MALLS
     * @uses self::VALUE_INTERNETANDNETWORKSERVICES_WEB_HOSTING_AND_DESIGN
     * @uses self::VALUE_MEDIAANDENTERTAINMENT_GENERAL
     * @uses self::VALUE_MEDIAANDENTERTAINMENT_CONCERTS
     * @uses self::VALUE_MEDIAANDENTERTAINMENT_THEATER
     * @uses self::VALUE_MEDICALANDPHARMACEUTICAL_GENERAL
     * @uses self::VALUE_MEDICALANDPHARMACEUTICAL_MEDICAL
     * @uses self::VALUE_MEDICALANDPHARMACEUTICAL_DENTAL
     * @uses self::VALUE_MEDICALANDPHARMACEUTICAL_OPTHAMALIC
     * @uses self::VALUE_MEDICALANDPHARMACEUTICAL_PRESCRIPTION_DRUGS
     * @uses self::VALUE_MEDICALANDPHARMACEUTICAL_DEVICES
     * @uses self::VALUE_MONEYSERVICEBUSINESSES_GENERAL
     * @uses self::VALUE_MONEYSERVICEBUSINESSES_REMITTANCE
     * @uses self::VALUE_MONEYSERVICEBUSINESSES_WIRE_TRANSFER
     * @uses self::VALUE_MONEYSERVICEBUSINESSES_MONEY_ORDERS
     * @uses self::VALUE_MONEYSERVICEBUSINESSES_ELECTRONIC_CASH
     * @uses self::VALUE_MONEYSERVICEBUSINESSES_CURRENCY_DEALER_EXCHANGE
     * @uses self::VALUE_MONEYSERVICEBUSINESSES_CHECK_CASHIER
     * @uses self::VALUE_MONEYSERVICEBUSINESSES_TRAVELERS_CHECKS
     * @uses self::VALUE_MONEYSERVICEBUSINESSES_STORED_VALUE_CARDS
     * @uses self::VALUE_NONPROFITPOLITICALANDRELIGION_GENERAL
     * @uses self::VALUE_NONPROFITPOLITICALANDRELIGION_CHARITIES
     * @uses self::VALUE_NONPROFITPOLITICALANDRELIGION_POLITICAL
     * @uses self::VALUE_NONPROFITPOLITICALANDRELIGION_RELIGIOUS
     * @uses self::VALUE_PETSANDANIMALS_GENERAL
     * @uses self::VALUE_PETSANDANIMALS_SUPPLIES_AND_TOYS
     * @uses self::VALUE_PETSANDANIMALS_WILDLIFE_PRODUCTS
     * @uses self::VALUE_REALESTATE_GENERAL
     * @uses self::VALUE_REALESTATE_COMMERCIAL
     * @uses self::VALUE_REALESTATE_RESIDENTIAL
     * @uses self::VALUE_REALESTATE_TIME_SHARES
     * @uses self::VALUE_SERVICES_GENERAL_GOVERNMENT
     * @uses self::VALUE_SERVICES_LEGAL
     * @uses self::VALUE_SERVICES_MEDICAL
     * @uses self::VALUE_SERVICES_DENTAL
     * @uses self::VALUE_SERVICES_VISION
     * @uses self::VALUE_SERVICES_GENERAL
     * @uses self::VALUE_SERVICES_CHILD_CARE_SERVICES
     * @uses self::VALUE_SERVICES_CONSULTING
     * @uses self::VALUE_SERVICES_IMPORTING_EXPORTING
     * @uses self::VALUE_SERVICES_INSURANCE_DIRECT
     * @uses self::VALUE_SERVICES_FINANCIAL_SERVICES
     * @uses self::VALUE_SERVICES_GRAPHIC_AND_COMMERCIAL_DESIGN
     * @uses self::VALUE_SERVICES_LANDSCAPING
     * @uses self::VALUE_SERVICES_LOCKSMITH
     * @uses self::VALUE_SERVICES_ONLINE_DATING
     * @uses self::VALUE_SERVICES_EVENT_AND_WEDDING_PLANNING
     * @uses self::VALUE_SERVICES_SCHOOLS_AND_COLLEGES
     * @uses self::VALUE_SERVICES_ENTERTAINMENT
     * @uses self::VALUE_SERVICES_AGGREGATORS
     * @uses self::VALUE_SPORTSANDRECREATION_GENERAL
     * @uses self::VALUE_SPORTSANDRECREATION_BICYCLES_AND_ACCESSORIES
     * @uses self::VALUE_SPORTSANDRECREATION_BOATING_SAILING_AND_ACCESSORIES
     * @uses self::VALUE_SPORTSANDRECREATION_CAMPING_AND_SURVIVAL
     * @uses self::VALUE_SPORTSANDRECREATION_EXERCISE_EQUIPMENT
     * @uses self::VALUE_SPORTSANDRECREATION_FISHING
     * @uses self::VALUE_SPORTSANDRECREATION_GOLF
     * @uses self::VALUE_SPORTSANDRECREATION_HUNTING
     * @uses self::VALUE_SPORTSANDRECREATION_PAINTBALL
     * @uses self::VALUE_SPORTSANDRECREATION_SPORTING_GOODS
     * @uses self::VALUE_SPORTSANDRECREATION_SWIMMING_POOLS_AND_SPAS
     * @uses self::VALUE_TRAVEL_GENERAL
     * @uses self::VALUE_TRAVEL_ACCOMMODATIONS
     * @uses self::VALUE_TRAVEL_AGENCIES
     * @uses self::VALUE_TRAVEL_AIRLINES
     * @uses self::VALUE_TRAVEL_AUTO_RENTALS
     * @uses self::VALUE_TRAVEL_CRUISES
     * @uses self::VALUE_TRAVEL_OTHER_TRANSPORTATION
     * @uses self::VALUE_TRAVEL_SERVICES
     * @uses self::VALUE_TRAVEL_SUPPLIES
     * @uses self::VALUE_TRAVEL_TOURS
     * @uses self::VALUE_TRAVEL_AIRLINES_SPIRIT_AIR
     * @uses self::VALUE_OTHER_SUB_CATEGORIES
     * @return string[]
     */
    public static function getValidValues()
    {
        return array(
            self::VALUE_SUB_CATEGORY_UNSPECIFIED,
            self::VALUE_ANTIQUES_GENERAL,
            self::VALUE_ANTIQUES_ANTIQUITIES,
            self::VALUE_ANTIQUES_DECORATIVE,
            self::VALUE_ANTIQUES_BOOKS_MANUSCRIPTS,
            self::VALUE_ANTIQUES_FURNITURE,
            self::VALUE_ANTIQUES_GLASS,
            self::VALUE_ANTIQUES_RUGS_CARPETS,
            self::VALUE_ANTIQUES_POTTERY,
            self::VALUE_ANTIQUES_CULTURAL,
            self::VALUE_ANTIQUES_ARTIFACTS_GRAVE_RELATED_AND_NATIVE_AMERICAN_CRAFTS,
            self::VALUE_ARTSANDCRAFTS_GENERAL,
            self::VALUE_ARTSANDCRAFTS_ART_DEALER_AND_GALLERIES,
            self::VALUE_ARTSANDCRAFTS_PRINTS,
            self::VALUE_ARTSANDCRAFTS_PAINTING,
            self::VALUE_ARTSANDCRAFTS_PHOTOGRAPHY,
            self::VALUE_ARTSANDCRAFTS_REPRODUCTIONS,
            self::VALUE_ARTSANDCRAFTS_SCULPTURES,
            self::VALUE_ARTSANDCRAFTS_WOODWORKING,
            self::VALUE_ARTSANDCRAFTS_ART_AND_CRAFT_SUPPLIES,
            self::VALUE_ARTSANDCRAFTS_FABRICS_AND_SEWING,
            self::VALUE_ARTSANDCRAFTS_QUILTING,
            self::VALUE_ARTSANDCRAFTS_SCRAPBOOKING,
            self::VALUE_AUTOMOTIVE_GENERAL,
            self::VALUE_AUTOMOTIVE_AUTOS,
            self::VALUE_AUTOMOTIVE_AVIATION,
            self::VALUE_AUTOMOTIVE_MOTORCYCLES,
            self::VALUE_AUTOMOTIVE_PARTS_AND_SUPPLIES,
            self::VALUE_AUTOMOTIVE_SERVICES,
            self::VALUE_AUTOMOTIVE_VINTAGE_AND_COLLECTIBLE_VEHICLES,
            self::VALUE_BEAUTY_GENERAL,
            self::VALUE_BEAUTY_BODY_CARE_PERSONAL_HYGIENE,
            self::VALUE_BEAUTY_FRAGRANCES_AND_PERFUMES,
            self::VALUE_BEAUTY_MAKEUP,
            self::VALUE_BOOKS_GENERAL,
            self::VALUE_BOOKS_AUDIO_BOOKS,
            self::VALUE_BOOKS_CHILDREN_BOOKS,
            self::VALUE_BOOKS_COMPUTER_BOOKS,
            self::VALUE_BOOKS_EDUCATIONAL_AND_TEXTBOOKS,
            self::VALUE_BOOKS_MAGAZINES,
            self::VALUE_BOOKS_FICTION_AND_LITERATURE,
            self::VALUE_BOOKS_NON_FICTION,
            self::VALUE_BOOKS_VINTAGE_AND_COLLECTIBLES,
            self::VALUE_BUSINESS_GENERAL,
            self::VALUE_BUSINESS_AGRICULTURAL,
            self::VALUE_BUSINESS_CONSTRUCTION,
            self::VALUE_BUSINESS_EDUCATIONAL,
            self::VALUE_BUSINESS_INDUSTRIAL,
            self::VALUE_BUSINESS_OFFICE_SUPPLIES_AND_EQUIPMENT,
            self::VALUE_BUSINESS_GENERAL_SERVICES,
            self::VALUE_BUSINESS_ADVERTISING,
            self::VALUE_BUSINESS_EMPLOYMENT,
            self::VALUE_BUSINESS_MARKETING,
            self::VALUE_BUSINESS_MEETING_PLANNERS,
            self::VALUE_BUSINESS_MESSAGING_AND_PAGING_SERVICES,
            self::VALUE_BUSINESS_SEMINARS,
            self::VALUE_BUSINESS_PUBLISHING,
            self::VALUE_BUSINESS_SHIPPING_AND_PACKAGING,
            self::VALUE_BUSINESS_WHOLESALE,
            self::VALUE_BUSINESS_INDUSTRIAL_SOLVENTS,
            self::VALUE_CAMERASANDPHOTOGRAPHY_GENERAL,
            self::VALUE_CAMERASANDPHOTOGRAPHY_ACCESSORIES,
            self::VALUE_CAMERASANDPHOTOGRAPHY_CAMERAS,
            self::VALUE_CAMERASANDPHOTOGRAPHY_VIDEO_EQUIPMENT,
            self::VALUE_CAMERASANDPHOTOGRAPHY_FILM,
            self::VALUE_CAMERASANDPHOTOGRAPHY_SUPPLIES,
            self::VALUE_CLOTHING_ACCESSORIES,
            self::VALUE_CLOTHING_BABIES_CLOTHING_AND_SUPPLIES,
            self::VALUE_CLOTHING_CHILDRENS_CLOTHING,
            self::VALUE_CLOTHING_MENS_CLOTHING,
            self::VALUE_CLOTHING_SHOES,
            self::VALUE_CLOTHING_WEDDING_CLOTHING,
            self::VALUE_CLOTHING_WOMENS_CLOTHING,
            self::VALUE_CLOTHING_GENERAL,
            self::VALUE_CLOTHING_JEWELRY,
            self::VALUE_CLOTHING_WATCHES_AND_CLOCKS,
            self::VALUE_CLOTHING_RINGS,
            self::VALUE_COLLECTIBLES_GENERAL,
            self::VALUE_COLLECTIBLES_ADVERTISING,
            self::VALUE_COLLECTIBLES_ANIMALS,
            self::VALUE_COLLECTIBLES_ANIMATION,
            self::VALUE_COLLECTIBLES_COIN_OPERATED_BANKS_AND_CASINOS,
            self::VALUE_COLLECTIBLES_COINS_AND_PAPER_MONEY,
            self::VALUE_COLLECTIBLES_COMICS,
            self::VALUE_COLLECTIBLES_DECORATIVE,
            self::VALUE_COLLECTIBLES_DISNEYANA,
            self::VALUE_COLLECTIBLES_HOLIDAY,
            self::VALUE_COLLECTIBLES_KNIVES_AND_SWORDS,
            self::VALUE_COLLECTIBLES_MILITARIA,
            self::VALUE_COLLECTIBLES_POSTCARDS_AND_PAPER,
            self::VALUE_COLLECTIBLES_STAMPS,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_GENERAL,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_DESKTOP_PCS,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_MONITORS,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_HARDWARE,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_PERIPHERALS,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_LAPTOPS_NOTEBOOKS_PDAS,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_NETWORKING_EQUIPMENT,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_PARTS_AND_ACCESSORIES,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_GENERAL_SOFTWARE,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_OEM_SOFTWARE,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_ACADEMIC_SOFTWARE,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_BETA_SOFTWARE,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_GAME_SOFTWARE,
            self::VALUE_COMPUTERHARDWAREANDSOFTWARE_DATA_PROCESSING_SVC,
            self::VALUE_CULTUREANDRELIGION_GENERAL,
            self::VALUE_CULTUREANDRELIGION_CHRISTIANITY,
            self::VALUE_CULTUREANDRELIGION_METAPHYSICAL,
            self::VALUE_CULTUREANDRELIGION_NEW_AGE,
            self::VALUE_CULTUREANDRELIGION_ORGANIZATIONS,
            self::VALUE_CULTUREANDRELIGION_OTHER_FAITHS,
            self::VALUE_CULTUREANDRELIGION_COLLECTIBLES,
            self::VALUE_ELECTRONICSANDTELECOM_GENERAL_TELECOM,
            self::VALUE_ELECTRONICSANDTELECOM_CELL_PHONES_AND_PAGERS,
            self::VALUE_ELECTRONICSANDTELECOM_TELEPHONE_CARDS,
            self::VALUE_ELECTRONICSANDTELECOM_TELEPHONE_EQUIPMENT,
            self::VALUE_ELECTRONICSANDTELECOM_TELEPHONE_SERVICES,
            self::VALUE_ELECTRONICSANDTELECOM_GENERAL_ELECTRONICS,
            self::VALUE_ELECTRONICSANDTELECOM_CAR_AUDIO_AND_ELECTRONICS,
            self::VALUE_ELECTRONICSANDTELECOM_HOME_ELECTRONICS,
            self::VALUE_ELECTRONICSANDTELECOM_HOME_AUDIO,
            self::VALUE_ELECTRONICSANDTELECOM_GADGETS_AND_OTHER_ELECTRONICS,
            self::VALUE_ELECTRONICSANDTELECOM_BATTERIES,
            self::VALUE_ELECTRONICSANDTELECOM_SCANNERS_RADIOS,
            self::VALUE_ELECTRONICSANDTELECOM_RADAR_DECTORS,
            self::VALUE_ELECTRONICSANDTELECOM_RADAR_JAMMING_DEVICES,
            self::VALUE_ELECTRONICSANDTELECOM_SATELLITE_AND_CABLE_TV_DESCRAMBLERS,
            self::VALUE_ELECTRONICSANDTELECOM_SURVEILLANCE_EQUIPMENT,
            self::VALUE_ENTERTAINMENT_GENERAL,
            self::VALUE_ENTERTAINMENT_MOVIES,
            self::VALUE_ENTERTAINMENT_MUSIC,
            self::VALUE_ENTERTAINMENT_CONCERTS,
            self::VALUE_ENTERTAINMENT_THEATER,
            self::VALUE_ENTERTAINMENT_BOOTLEG_RECORDINGS,
            self::VALUE_ENTERTAINMENT_PROMOTIONAL_ITEMS,
            self::VALUE_ENTERTAINMENTMEMORABILIA_GENERAL,
            self::VALUE_ENTERTAINMENTMEMORABILIA_AUTOGRAPHS,
            self::VALUE_ENTERTAINMENTMEMORABILIA_LIMITED_EDITIONS,
            self::VALUE_ENTERTAINMENTMEMORABILIA_MOVIE,
            self::VALUE_ENTERTAINMENTMEMORABILIA_MUSIC,
            self::VALUE_ENTERTAINMENTMEMORABILIA_NOVELTIES,
            self::VALUE_ENTERTAINMENTMEMORABILIA_PHOTOS,
            self::VALUE_ENTERTAINMENTMEMORABILIA_POSTERS,
            self::VALUE_ENTERTAINMENTMEMORABILIA_SPORTS_AND_FAN_SHOP,
            self::VALUE_ENTERTAINMENTMEMORABILIA_SCIENCE_FICTION,
            self::VALUE_FOODDRINKANDNUTRITION_GENERAL,
            self::VALUE_FOODDRINKANDNUTRITION_COFFEE_AND_TEA,
            self::VALUE_FOODDRINKANDNUTRITION_FOOD_PRODUCTS,
            self::VALUE_FOODDRINKANDNUTRITION_GOURMET_ITEMS,
            self::VALUE_FOODDRINKANDNUTRITION_HEALTH_AND_NUTRITION,
            self::VALUE_FOODDRINKANDNUTRITION_SERVICES,
            self::VALUE_FOODDRINKANDNUTRITION_VITAMINS_AND_SUPPLEMENTS,
            self::VALUE_FOODDRINKANDNUTRITION_WEIGHT_MANAGEMENT_AND_HEALTH_PRODUCTS,
            self::VALUE_FOODDRINKANDNUTRITION_RESTAURANT,
            self::VALUE_FOODDRINKANDNUTRITION_TOBACCO_AND_CIGARS,
            self::VALUE_FOODDRINKANDNUTRITION_ALCOHOLIC_BEVERAGES,
            self::VALUE_GIFTSANDFLOWERS_GENERAL,
            self::VALUE_GIFTSANDFLOWERS_FLOWERS,
            self::VALUE_GIFTSANDFLOWERS_GREETING_CARDS,
            self::VALUE_GIFTSANDFLOWERS_HUMOROUS_GIFTS_AND_NOVELTIES,
            self::VALUE_GIFTSANDFLOWERS_PERSONALIZED_GIFTS,
            self::VALUE_GIFTSANDFLOWERS_PRODUCTS,
            self::VALUE_GIFTSANDFLOWERS_SERVICES,
            self::VALUE_HOBBIESTOYSANDGAMES_GENERAL,
            self::VALUE_HOBBIESTOYSANDGAMES_ACTION_FIGURES,
            self::VALUE_HOBBIESTOYSANDGAMES_BEAN_BABIES,
            self::VALUE_HOBBIESTOYSANDGAMES_BARBIES,
            self::VALUE_HOBBIESTOYSANDGAMES_BEARS,
            self::VALUE_HOBBIESTOYSANDGAMES_DOLLS,
            self::VALUE_HOBBIESTOYSANDGAMES_GAMES,
            self::VALUE_HOBBIESTOYSANDGAMES_MODEL_KITS,
            self::VALUE_HOBBIESTOYSANDGAMES_DIECAST_TOYS_VEHICLES,
            self::VALUE_HOBBIESTOYSANDGAMES_VIDEO_GAMES_AND_SYSTEMS,
            self::VALUE_HOBBIESTOYSANDGAMES_VINTAGE_AND_ANTIQUE_TOYS,
            self::VALUE_HOBBIESTOYSANDGAMES_BACKUP_UNRELEASED_GAMES,
            self::VALUE_HOBBIESTOYSANDGAMES_GAME_COPYING_HARDWARESOFTWARE,
            self::VALUE_HOBBIESTOYSANDGAMES_MOD_CHIPS,
            self::VALUE_HOMEANDGARDEN_GENERAL,
            self::VALUE_HOMEANDGARDEN_APPLIANCES,
            self::VALUE_HOMEANDGARDEN_BED_AND_BATH,
            self::VALUE_HOMEANDGARDEN_FURNISHING_AND_DECORATING,
            self::VALUE_HOMEANDGARDEN_GARDEN_SUPPLIES,
            self::VALUE_HOMEANDGARDEN_HARDWARE_AND_TOOLS,
            self::VALUE_HOMEANDGARDEN_HOUSEHOLD_GOODS,
            self::VALUE_HOMEANDGARDEN_KITCHENWARE,
            self::VALUE_HOMEANDGARDEN_RUGS_AND_CARPETS,
            self::VALUE_HOMEANDGARDEN_SECURITY_AND_HOME_DEFENSE,
            self::VALUE_HOMEANDGARDEN_PLANTS_AND_SEEDS,
            self::VALUE_INTERNETANDNETWORKSERVICES_GENERAL,
            self::VALUE_INTERNETANDNETWORKSERVICES_BULLETIN_BOARD,
            self::VALUE_INTERNETANDNETWORKSERVICES_ONLINE_SERVICES,
            self::VALUE_INTERNETANDNETWORKSERVICES_AUCTION_MANAGEMENT_TOOLS,
            self::VALUE_INTERNETANDNETWORKSERVICES_ECOMMERCE_DEVELOPMENT,
            self::VALUE_INTERNETANDNETWORKSERVICES_TRAINING_SERVICES,
            self::VALUE_INTERNETANDNETWORKSERVICES_ONLINE_MALLS,
            self::VALUE_INTERNETANDNETWORKSERVICES_WEB_HOSTING_AND_DESIGN,
            self::VALUE_MEDIAANDENTERTAINMENT_GENERAL,
            self::VALUE_MEDIAANDENTERTAINMENT_CONCERTS,
            self::VALUE_MEDIAANDENTERTAINMENT_THEATER,
            self::VALUE_MEDICALANDPHARMACEUTICAL_GENERAL,
            self::VALUE_MEDICALANDPHARMACEUTICAL_MEDICAL,
            self::VALUE_MEDICALANDPHARMACEUTICAL_DENTAL,
            self::VALUE_MEDICALANDPHARMACEUTICAL_OPTHAMALIC,
            self::VALUE_MEDICALANDPHARMACEUTICAL_PRESCRIPTION_DRUGS,
            self::VALUE_MEDICALANDPHARMACEUTICAL_DEVICES,
            self::VALUE_MONEYSERVICEBUSINESSES_GENERAL,
            self::VALUE_MONEYSERVICEBUSINESSES_REMITTANCE,
            self::VALUE_MONEYSERVICEBUSINESSES_WIRE_TRANSFER,
            self::VALUE_MONEYSERVICEBUSINESSES_MONEY_ORDERS,
            self::VALUE_MONEYSERVICEBUSINESSES_ELECTRONIC_CASH,
            self::VALUE_MONEYSERVICEBUSINESSES_CURRENCY_DEALER_EXCHANGE,
            self::VALUE_MONEYSERVICEBUSINESSES_CHECK_CASHIER,
            self::VALUE_MONEYSERVICEBUSINESSES_TRAVELERS_CHECKS,
            self::VALUE_MONEYSERVICEBUSINESSES_STORED_VALUE_CARDS,
            self::VALUE_NONPROFITPOLITICALANDRELIGION_GENERAL,
            self::VALUE_NONPROFITPOLITICALANDRELIGION_CHARITIES,
            self::VALUE_NONPROFITPOLITICALANDRELIGION_POLITICAL,
            self::VALUE_NONPROFITPOLITICALANDRELIGION_RELIGIOUS,
            self::VALUE_PETSANDANIMALS_GENERAL,
            self::VALUE_PETSANDANIMALS_SUPPLIES_AND_TOYS,
            self::VALUE_PETSANDANIMALS_WILDLIFE_PRODUCTS,
            self::VALUE_REALESTATE_GENERAL,
            self::VALUE_REALESTATE_COMMERCIAL,
            self::VALUE_REALESTATE_RESIDENTIAL,
            self::VALUE_REALESTATE_TIME_SHARES,
            self::VALUE_SERVICES_GENERAL_GOVERNMENT,
            self::VALUE_SERVICES_LEGAL,
            self::VALUE_SERVICES_MEDICAL,
            self::VALUE_SERVICES_DENTAL,
            self::VALUE_SERVICES_VISION,
            self::VALUE_SERVICES_GENERAL,
            self::VALUE_SERVICES_CHILD_CARE_SERVICES,
            self::VALUE_SERVICES_CONSULTING,
            self::VALUE_SERVICES_IMPORTING_EXPORTING,
            self::VALUE_SERVICES_INSURANCE_DIRECT,
            self::VALUE_SERVICES_FINANCIAL_SERVICES,
            self::VALUE_SERVICES_GRAPHIC_AND_COMMERCIAL_DESIGN,
            self::VALUE_SERVICES_LANDSCAPING,
            self::VALUE_SERVICES_LOCKSMITH,
            self::VALUE_SERVICES_ONLINE_DATING,
            self::VALUE_SERVICES_EVENT_AND_WEDDING_PLANNING,
            self::VALUE_SERVICES_SCHOOLS_AND_COLLEGES,
            self::VALUE_SERVICES_ENTERTAINMENT,
            self::VALUE_SERVICES_AGGREGATORS,
            self::VALUE_SPORTSANDRECREATION_GENERAL,
            self::VALUE_SPORTSANDRECREATION_BICYCLES_AND_ACCESSORIES,
            self::VALUE_SPORTSANDRECREATION_BOATING_SAILING_AND_ACCESSORIES,
            self::VALUE_SPORTSANDRECREATION_CAMPING_AND_SURVIVAL,
            self::VALUE_SPORTSANDRECREATION_EXERCISE_EQUIPMENT,
            self::VALUE_SPORTSANDRECREATION_FISHING,
            self::VALUE_SPORTSANDRECREATION_GOLF,
            self::VALUE_SPORTSANDRECREATION_HUNTING,
            self::VALUE_SPORTSANDRECREATION_PAINTBALL,
            self::VALUE_SPORTSANDRECREATION_SPORTING_GOODS,
            self::VALUE_SPORTSANDRECREATION_SWIMMING_POOLS_AND_SPAS,
            self::VALUE_TRAVEL_GENERAL,
            self::VALUE_TRAVEL_ACCOMMODATIONS,
            self::VALUE_TRAVEL_AGENCIES,
            self::VALUE_TRAVEL_AIRLINES,
            self::VALUE_TRAVEL_AUTO_RENTALS,
            self::VALUE_TRAVEL_CRUISES,
            self::VALUE_TRAVEL_OTHER_TRANSPORTATION,
            self::VALUE_TRAVEL_SERVICES,
            self::VALUE_TRAVEL_SUPPLIES,
            self::VALUE_TRAVEL_TOURS,
            self::VALUE_TRAVEL_AIRLINES_SPIRIT_AIR,
            self::VALUE_OTHER_SUB_CATEGORIES,
        );
    }
}
