...
/**
 * This class stands for BusinessCategoryType EnumType
...
class BusinessCategoryType
{
     ...
     * @uses self::VALUE_CATEGORY_UNSPECIFIED
     * @uses self::VALUE_ANTIQUES
     * @uses self::VALUE_ARTS
     * @uses self::VALUE_AUTOMOTIVE
     * @uses self::VALUE_BEAUTY
     * @uses self::VALUE_BOOKS
     * @uses self::VALUE_BUSINESS
     * @uses self::VALUE_CAMERAS_AND_PHOTOGRAPHY
     * @uses self::VALUE_CLOTHING
     * @uses self::VALUE_COLLECTIBLES
     * @uses self::VALUE_COMPUTER_HARDWARE_AND_SOFTWARE
     * @uses self::VALUE_CULTURE_AND_RELIGION
     * @uses self::VALUE_ELECTRONICS_AND_TELECOM
     * @uses self::VALUE_ENTERTAINMENT
     * @uses self::VALUE_ENTERTAINMENT_MEMORABILIA
     * @uses self::VALUE_FOOD_DRINK_AND_NUTRITION
     * @uses self::VALUE_GIFTS_AND_FLOWERS
     * @uses self::VALUE_HOBBIES_TOYS_AND_GAMES
     * @uses self::VALUE_HOME_AND_GARDEN
     * @uses self::VALUE_INTERNET_AND_NETWORK_SERVICES
     * @uses self::VALUE_MEDIA_AND_ENTERTAINMENT
     * @uses self::VALUE_MEDICAL_AND_PHARMACEUTICAL
     * @uses self::VALUE_MONEY_SERVICE_BUSINESSES
     * @uses self::VALUE_NON_PROFIT_POLITICAL_AND_RELIGION
     * @uses self::VALUE_NOT_ELSEWHERE_CLASSIFIED
     * @uses self::VALUE_PETS_AND_ANIMALS
     * @uses self::VALUE_REAL_ESTATE
     * @uses self::VALUE_SERVICES
     * @uses self::VALUE_SPORTS_AND_RECREATION
     * @uses self::VALUE_TRAVEL
     * @uses self::VALUE_OTHER_CATEGORIES
     * @return string[]
     */
    public static function getValidValues()
    {
        return array(
            self::VALUE_CATEGORY_UNSPECIFIED,
            self::VALUE_ANTIQUES,
            self::VALUE_ARTS,
            ...
            self::VALUE_BOOKS,
            self::VALUE_BUSINESS,
            self::VALUE_CAMERAS_AND_PHOTOGRAPHY,
            self::VALUE_CLOTHING,
            self::VALUE_COLLECTIBLES,
            self::VALUE_COMPUTER_HARDWARE_AND_SOFTWARE,
            self::VALUE_CULTURE_AND_RELIGION,
            self::VALUE_ELECTRONICS_AND_TELECOM,
            self::VALUE_ENTERTAINMENT,
            self::VALUE_ENTERTAINMENT_MEMORABILIA,
            self::VALUE_FOOD_DRINK_AND_NUTRITION,
            self::VALUE_GIFTS_AND_FLOWERS,
            self::VALUE_HOBBIES_TOYS_AND_GAMES,
            self::VALUE_HOME_AND_GARDEN,
            self::VALUE_INTERNET_AND_NETWORK_SERVICES,
            self::VALUE_MEDIA_AND_ENTERTAINMENT,
            self::VALUE_MEDICAL_AND_PHARMACEUTICAL,
            self::VALUE_MONEY_SERVICE_BUSINESSES,
            self::VALUE_NON_PROFIT_POLITICAL_AND_RELIGION,
            self::VALUE_NOT_ELSEWHERE_CLASSIFIED,
            self::VALUE_PETS_AND_ANIMALS,
            self::VALUE_REAL_ESTATE,
            self::VALUE_SERVICES,
            self::VALUE_SPORTS_AND_RECREATION,
            self::VALUE_TRAVEL,
            self::VALUE_OTHER_CATEGORIES,
        );
    }
    /**
