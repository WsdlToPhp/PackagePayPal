 ...
 */
class Complete extends SoapClientBase
{
    /**
     ...
     * @param \PayPal\StructType\CompleteRecoupReq $completeRecoupRequest
     * @return \PayPal\StructType\CompleteRecoupResponseType|bool
     */
