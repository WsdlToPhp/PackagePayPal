 ...
 */
class Reverse extends SoapClientBase
{
    /**
     ...
     * @param \PayPal\StructType\ReverseTransactionReq $reverseTransactionRequest
     * @return \PayPal\StructType\ReverseTransactionResponseType|bool
     */
