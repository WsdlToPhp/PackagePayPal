...
class BMUpdateButtonRequestType extends AbstractRequestType
{
    ...
    public function setButtonVar(array $buttonVar = array())
    {
        foreach ($buttonVar as $bMUpdateButtonRequestTypeButtonVarItem) {
            ...
            if (!is_string($bMUpdateButtonRequestTypeButtonVarItem)) {
                throw new \InvalidArgumentException(sprintf('The ButtonVar property can only contain items of string, "%s" given', is_object($bMUpdateButtonRequestTypeButtonVarItem) ? get_class($bMUpdateButtonRequestTypeButtonVarItem) : gettype($bMUpdateButtonRequestTypeButtonVarItem)), __LINE__);
            }
        }
    ...
    {
        foreach ($optionDetails as $bMUpdateButtonRequestTypeOptionDetailsItem) {
            // validation for constraint: itemType
            if (!$bMUpdateButtonRequestTypeOptionDetailsItem instanceof \PayPal\StructType\OptionDetailsType) {
                throw new \InvalidArgumentException(sprintf('The OptionDetails property can only contain items of \PayPal\StructType\OptionDetailsType, "%s" given', is_object($bMUpdateButtonRequestTypeOptionDetailsItem) ? get_class($bMUpdateButtonRequestTypeOptionDetailsItem) : gettype($bMUpdateButtonRequestTypeOptionDetailsItem)), __LINE__);
            }
        }
    ...
    {
        foreach ($textBox as $bMUpdateButtonRequestTypeTextBoxItem) {
            // validation for constraint: itemType
            if (!is_string($bMUpdateButtonRequestTypeTextBoxItem)) {
                throw new \InvalidArgumentException(sprintf('The TextBox property can only contain items of string, "%s" given', is_object($bMUpdateButtonRequestTypeTextBoxItem) ? get_class($bMUpdateButtonRequestTypeTextBoxItem) : gettype($bMUpdateButtonRequestTypeTextBoxItem)), __LINE__);
            }
        }
